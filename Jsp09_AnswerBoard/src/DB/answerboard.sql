...
--세번째 글 작성
INSERT INTO ANSWERBOARD VALUES(BOARDNOSQ.NEXTVAL, GROUPNOSQ.NEXTVAL, 1, 0, '세번째 글','3번 글 입니다!!','유저3',SYSDATE);
...
VALUES(
	...
	'RE:두번째 글','2번글에 답변 글입니다.','유저1',SYSDATE);

DELETE FROM ANSWERBOARD WHERE BOARDNO=5;
...
VALUES(
	...
	'RE:두번째 글','2번글에 답변 글에 답변 글.','유저2',SYSDATE);
...
VALUES(
	...
	(SELECT GROUPSQ FROM ANSWERBOARD WHERE BOARDNO=2)+1,
	(SELECT TITLETAB FROM ANSWERBOARD WHERE BOARDNO=2)+2,
	'RE:두번째 글','2번글에 답변 글 두번째임','유저3',SYSDATE);


--답변 작성(NO-7)
--1. UPDATE
--  부모와 같은 GROUPNO이고 부모의 GROUPSQ보다 큰 글들의 GRUOPSQ+1
...
VALUES(
	...
	'RE:RE:두번째 글#@#','2번글에 답변 글의 답변','유저2',SYSDATE);
